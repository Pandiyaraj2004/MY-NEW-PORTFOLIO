  ...
  return (
    ...
    >
      <div className="max-w-5xl mx-auto w-full flex flex-col items-center text-center">
        ...
        {/* Profile Portrait & 3D Depth Aura */}
        <div className="relative mb-7 group">
          <div className="absolute -inset-3 rounded-full bg-gradient-to-r from-indigo-500 via-cyan-400 to-violet-500 opacity-40 blur-lg group-hover:opacity-75 transition-opacity duration-500" />
          
          <div className="relative w-36 h-36 sm:w-40 sm:h-40 rounded-full p-1.5 bg-gradient-to-b from-white/20 to-white/5 border border-white/20 shadow-2xl backdrop-blur-md overflow-hidden">
            <img
          ...
          <div className="absolute -bottom-2.5 left-1/2 -translate-x-1/2 whitespace-nowrap px-3.5 py-1 rounded-full glass-panel text-[10px] font-mono font-bold text-indigo-400 shadow-xl flex items-center gap-1.5 border border-indigo-500/40">
